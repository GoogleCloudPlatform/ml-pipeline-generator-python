...
def build_estimator(config, embedding_size=8, hidden_units=None):
    ...
    (deep_columns, wide_columns) = get_deep_and_wide_columns(embedding_size)
...
def _decode_csv(line):
    ...
    columns = tf.decode_csv(
        row_columns, record_defaults=CSV_COLUMN_DEFAULTS)
...
def input_fn(filenames,
    ...
    return features, _parse_label_column(features.pop(LABEL_COLUMN))
